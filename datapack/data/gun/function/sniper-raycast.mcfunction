...
execute unless entity @e[tag=!gun_shooter,dx=0,dy=0,dz=0] if score @s gun_ray matches ..499 positioned ^ ^ ^0.25 if block ~ ~ ~ #gun:raycast_pass run setblock ~ ~ ~ air destroy